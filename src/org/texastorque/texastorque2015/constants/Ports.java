...
public class Ports {
    ...
    public final static int LEFT_ELEVATOR_ENCODER_PORT_A = 7;
    public final static int LEFT_ELEVATOR_ENCODER_PORT_B = 6;
    ...
    public final static int TILT_SOLENOID_A_PORT = 7;
